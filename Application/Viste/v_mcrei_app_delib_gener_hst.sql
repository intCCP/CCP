/* Formatted on 21/07/2014 18:39:32 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DELIB_GENER_HST
(
   COD_SNDG,
...
AS
   SELECT --0221 introdotta nuova pcr_rapp_aggr                                                                                                                                                                                                                                    -- 0216 aggiunto filtro fase_del != 'AN'
         DISTINCT
          ...
          d.dta_scadenza AS dta_scadenza_stato,                   ---10 aprile
          ...
          (SELECT r.*,
            ...
            WHERE     r.cod_abi_cartolarizzato = i.cod_abi_cartolarizzato(+)
                  AND r.cod_ndg = i.cod_ndg(+)                           --5/3
                                              /*GROUP BY    cod_abi_cartolarizzato, cod_ndg*/
          ) p,
