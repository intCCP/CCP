/* Formatted on 21/07/2014 18:44:43 (QP5 v5.227.12220.39754) */
...
AS
   SELECT                                --  20121102    AG  Created this view
           ...
           --  20140610   VG  aggiunti codici per cofice_fiscale e partita_iva
        cod_autorizzazione,
        CASE
           ...
           WHEN flg_chk_cf = 1 THEN '2076'
           WHEN flg_chk_pi = 1 THEN '2077'
        END
           cod_causa_scarto,
        CASE
           ...
           WHEN flg_chk_cf = 1
           THEN
              'Codice fiscale errato o nullo'
           WHEN flg_chk_pi = 1
           THEN
              'Partita iva errata o nulla'
        END
           desc_causa_scarto
   FROM (  SELECT cod_autorizzazione,
                  ...
                  MAX (w.flg_chk_pi) flg_chk_pi,
                  MAX (w.flg_chk_cf) flg_chk_cf
