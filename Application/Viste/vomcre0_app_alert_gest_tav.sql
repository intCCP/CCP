/* Formatted on 21/07/2014 18:45:43 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VOMCRE0_APP_ALERT_GEST_TAV
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
...
AS
   SELECT                                  -- v1 06/05/2011 VG: COD_MACROSTATO
          ...
          x.dta_servizio,
          x.dta_servizio + c.val_gg_prima_proroga dta_limite_proroga,
          i.flg_abi_lavorato
