/* Formatted on 21/07/2014 18:45:30 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VNMCRE0_APP_PT_GESTIONE_TAVOLI
(
...
AS
   SELECT                    --v1.1 07.02.11 MM -- upd_field al posto di mople
     ...
     FROM t_mcre0_app_pt_gestione_tavoli t, V_MCRE0_APP_UPD_FIELDS_P1 m
