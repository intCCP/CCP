/* Formatted on 21/07/2014 18:32:07 (QP5 v5.227.12220.39754) */
                              ...
                              WHEN (   (    b.val_livello = 'DIREZIONE'
                                    ...
                                    OR (    (   (    b.val_livello IN
                                                        ('DIVISIONE',
                                                         ...
                                                         'REGIONE')
                                                 --Modifica per regioni e aree
                                                 --1009- lascio controllo iris solo per IN/RS, nuovo case per OC)
                                                 AND cod_stato IN
                                                        ('IN', 'RS'))
                                             OR (    b.val_livello IN
                                                        ('DIVISIONE') --Modifica per regioni e aree
                                --1009- lascio controllo iris OC di divisione)
                                                 AND cod_stato IN ('OC')))
                                        AND 1 =
                                               (SELECT DISTINCT
                                                       CASE
                                               ...
                                               (SELECT DISTINCT 1
                                                 ...
                                                 WHERE     g.cod_abi_cartolarizzato =
                                                       ...
                                                       AND NVL (
                                                              ...
                                                              0) > 0))
                                    OR (    b.val_livello IN
                                               ('AREA', 'REGIONE') --Modifica per regioni e aree
                                        --1009- lascio controllo iris solo per IN/RS, nuovo case per OC)
                                        AND cod_stato IN ('OC')
                                        AND EXISTS
                                               (SELECT DISTINCT 1
