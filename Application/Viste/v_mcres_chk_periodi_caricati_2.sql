/* Formatted on 21/07/2014 18:43:35 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_CHK_PERIODI_CARICATI_2
(
   COD_ABI,
   ABI,
   FLUSSO,
...
AS
     SELECT B.COD_ABI,
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-01' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_01,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-02' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_02,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-03' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_03,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-04' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_04,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-05' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_05,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-06' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_06,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-07' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_07,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-08' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_08,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-09' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_09,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-10' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_10,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-11' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_11,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2009-12' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2009_12,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-01' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_01,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-02' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_02,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-03' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_03,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-04' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_04,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-05' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_05,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-06' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_06,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-07' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_07,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-08' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_08,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-09' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_09,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-10' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_10,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-11' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_11,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2010-12' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2010_12,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-01' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_01,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-02' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_02,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-03' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_03,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-04' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_04,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-05' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_05,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-06' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_06,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-07' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_07,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-08' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_08,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-09' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_09,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-10' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_10,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-11' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_11,
               MAX (
            ...
            || '('
            || MAX (
                  CASE WHEN PERIODO = '2011-12' THEN TOTALE_scarti ELSE 0 END)
            || ')'
               P_2011_12
       FROM (SELECT S.*,
                    CASE
                       ...
                       WHEN COD_FLUSSO = 'EFFETTI_ECONOMICI'
                       THEN
                          (  SELECT COUNT (*) TOTALE_RECORD
                               FROM T_MCRES_APP_EFFETTI_ECONOMICI E
                              WHERE     E.COD_ABI = S.COD_ABI
                                    AND E.ID_DPER = S.ID_DPER
                           GROUP BY COD_ABI, ID_DPER)
                       WHEN COD_FLUSSO = 'MOVIMENTI_MOD_MOV'
                       THEN
                          (  SELECT COUNT (*) TOTALE_RECORD
                               FROM T_MCRES_APP_MOVIMENTI_MOD_MOV M
                              WHERE     M.COD_ABI = S.COD_ABI
                                    AND M.ID_DPER = S.ID_DPER
                           GROUP BY COD_ABI, ID_DPER)
                    END
                       TOTALE_RECORD
