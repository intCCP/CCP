/* Formatted on 21/07/2014 18:45:48 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VOMCRE0_APP_ALERT_POS_DA_CLASS
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
   ...
   SELECT                                  -- V1 ??/??/???? VG: prima versione
          ...
          CASE
             ...
             THEN
                1
             WHEN     X.COD_MACROSTATO = 'RIO'
                  AND R.COD_MACROSTATO_DESTINAZIONE = 'ES'
             THEN
                1
             WHEN     X.COD_MACROSTATO = 'GB'
                  AND X.COD_MACROSTATO_PROPOSTO = 'RIO'
             THEN
                1
             ELSE
                0
          ...
          CASE
             ...
             THEN
                1
             WHEN     X.COD_MACROSTATO = 'RIO'
                  AND R.COD_MACROSTATO_DESTINAZIONE = 'SO'
             THEN
                1
             WHEN     X.COD_MACROSTATO = 'GB'
