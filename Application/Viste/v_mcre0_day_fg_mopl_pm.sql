/* Formatted on 21/07/2014 18:36:50 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_DAY_FG_MOPL_PM
(
   TODAY_FLG,
   ID_DPER,
   ID_DPERFG,
                  ...
                  CASE
                     ...
                     THEN
                        ...
                        || SUBSTR (
                              ...
                              || CASE
                                    WHEN cod_stato = 'PM' THEN 'PM'
                                    ELSE '00'
                                 END
                              || SUBSTR (cod_gruppo_super_1, 10, 10),
                              LENGTH (cod_comparto_calcolato) + 1,
                              20)                                           --
                     ELSE
                           SUBSTR (cod_gruppo_super_1, 1, 7)
                        || CASE WHEN cod_stato = 'PM' THEN 'PM' ELSE '00' END
                        || SUBSTR (cod_gruppo_super_1, 10, 10)
                  END
                     cod_gruppo_super,
                  CASE
