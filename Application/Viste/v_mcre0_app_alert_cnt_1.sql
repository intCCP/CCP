/* Formatted on 21/07/2014 18:31:45 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_ALERT_CNT_1
(
   ID_UTENTE,
   ID_REFERENTE,
   ...
   UNION
     SELECT id_utente,
       ...
       FROM (  SELECT id_alert_da_esporre,
                      ...
                      SUM (
                         CASE
                            WHEN alert = 'G' AND x.cod_macrostato = 'SO' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         cnt_SO_g,
                      SUM (
