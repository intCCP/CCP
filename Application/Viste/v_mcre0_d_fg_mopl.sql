/* Formatted on 21/07/2014 18:36:43 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_D_FG_MOPL
(
   TODAY_FLG,
   ID_DPER,
   COD_ABI_ISTITUTO,
...
AS
   SELECT TODAY_FLG,
          ...
          COD_RAMO_CALCOLATO,
          COD_COMPARTO_CALCOLATO,
          COD_GRUPPO_SUPER, --mc 27/05/14 Modificata logica per variazione perimetro DR
          COD_GRUPPO_SUPER_OLD, --mc 27/05/14 Modificata logica per variazione perimetro DR
          ID_STATO_POSIZIONE,
          COD_CLIENTE_ESTESO,
          ID_CLIENTE_ESTESO,
          DESC_ANAG_GESTORE_MKT,
                     ...
                     WHEN     cod_ramo_calcolato IS NULL
                          AND EXISTS
                                 (SELECT DISTINCT
                                         cod_abi_istituto,
                                         cod_struttura_competente
                                    FROM t_mcre0_app_struttura_org sorg
