/* Formatted on 21/07/2014 18:46:04 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VOMCRE0_APP_ARCHIVIO
(
   DTA_UPD,
   COD_RAMO_CALCOLATO,
   COD_COMPARTO,
...
AS
   SELECT TO_CHAR (SYSDATE, 'DDMMYY') DTA_UPD,
     ...
     FROM MV_MCRE0_ANAGRAFICA_GENERALE G,
          ...
          (SELECT *
            ...
            WHERE SUBSTR (COD_MESE_HST, 1, 6) =
                     TO_CHAR (ADD_MONTHS (SYSDATE, -1), 'YYYYMM')) e
    WHERE     XX.COD_ABI_CARTOLARIZZATO = G.COD_ABI_CARTOLARIZZATO
