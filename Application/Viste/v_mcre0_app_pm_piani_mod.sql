/* Formatted on 21/07/2014 18:34:26 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_PM_PIANI_MOD
(
   COD_ABI_ISTITUTO,
...
AS
   SELECT                                        --VG 20140707 totale utilizzi
         a.COD_ABI_ISTITUTO,
    ...
    WHERE     a.COD_ABI_CARTOLARIZZATO = p.COD_ABI_CARTOLARIZZATO
          ...
          AND P.FLG_PIANO_MODIFICATO = 'S'
          AND NVL (P.FLG_PRESA_VISIONE_MODIFICA, '0') != '1'
          AND NVL (P.DTA_SCADENZA, SYSDATE + 1) >= SYSDATE
          AND COD_TIPO_PIANO IN ('S', 'C');
