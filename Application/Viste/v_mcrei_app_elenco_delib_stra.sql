/* Formatted on 21/07/2014 18:40:11 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_ELENCO_DELIB_STRA
(
   ID_DPER,
...
AS
   SELECT TO_NUMBER (
             TO_CHAR (TRUNC (D.dta_last_upd_delibera, 'MM'), 'YYYYMMDD'))
             id_dper,
    ...
    WHERE                         --d.cod_fase_pacchetto NOT IN ('ANA', 'ANM')
              ...
              d.flg_no_delibera = '0'
          AND d.flg_attiva = '1'
          AND TRUNC (D.dta_last_upd_delibera, 'MM') = TRUNC (SYSDATE)
