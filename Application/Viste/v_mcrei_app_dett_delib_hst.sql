/* Formatted on 21/07/2014 18:39:51 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DETT_DELIB_HST
(
...
AS
   ...
   WHERE     d.cod_abi = p.cod_abi(+)
         ...
         AND d.cod_fase_delibera != 'AN'                               ---6MAR
