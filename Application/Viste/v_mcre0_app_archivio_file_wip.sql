/* Formatted on 21/07/2014 18:33:12 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_ARCHIVIO_FILE_WIP
(
   VAL_ARCHIVIO
)
AS
   SELECT    DTA_UPD
          ...
          || RPAD (NVL (TIPO_PRATICA, ' '), 300, ' ')
             VAL_ARCHIVIO
     FROM MCRE_OWN.V_MCRE0_APP_ARCHIVIO_WIP;
