/* Formatted on 21/07/2014 18:39:49 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DETT_DATI_GEN_RV2
(
   COD_ABI,
   COD_NDG,
   COD_PROT_DELIBERA,
...
AS
   SELECT cod_abi,
     ...
     FROM (SELECT DISTINCT
                  ...
                  ---19 SEP: AD  nel caso che la delib arrivi da Host, val_rdv_rapp_operativi viene preso da rdv_progressiva
                  DECODE (d2.cod_tipo_pacchetto,
                          'M', d2.val_rdv_rapp_operativi,
                          d2.val_rdv_qc_progressiva)
                     AS val_rett_rapp_op_delib,   --ultima delibera PRECEDENTE
