/* Formatted on 21/07/2014 18:39:59 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DETT_RAPP_RV_HST
(
   COD_ABI,
   COD_NDG,
   DTA_STIMA,
...
AS
   SELECT DISTINCT
     ...
     FROM (SELECT DISTINCT
                  ...
                  ---in pcr l'utilizzato è già comprensivo di mora
                  DECODE (
                     pcr.cod_classe_ft,
                  ...
                  --MODIFICATO IL 13 MARZO PER CAMBIO LOGICA
                  DECODE (h.cod_rapporto, NULL, 'N', 'Y') AS flg_storico, ----verificare
                  ...
                  TO_DATE (NULL) dta_inizio_segnalazione_ristr,
                  --2 maggio
                  TO_DATE (NULL) dta_fine_segnalazione_ristr,       --2 maggio
