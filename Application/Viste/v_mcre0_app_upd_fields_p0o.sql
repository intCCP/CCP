/* Formatted on 21/07/2014 18:36:25 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_P0O
(
   TODAY_FLG,
   P_ROWID,
   U_ROWID,
...
AS
   SELECT "TODAY_FLG",
          ...
          "GLGB_UTI_CASSA",
          "GLGB_UTI_FIRMA"
     FROM MV_MCRE0_APP_UPD_FIELDS PARTITION (CCP_P0);
