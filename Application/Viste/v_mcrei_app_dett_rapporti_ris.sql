/* Formatted on 21/07/2014 18:40:03 (QP5 v5.227.12220.39754) */
   ...
   SELECT DISTINCT
     ...
     FROM (   /*BEGIN dbms_application_info.set_client_info( abi||ndg); END;*/
            (SELECT DISTINCT
                    ...
                    ---in pcr l'utilizzato S gi¿ comprensivo di mora
           ...
           (SELECT DISTINCT
                   ...
                   'Y' AS flg_storico,
                   ---- 23 MAGGIO   : SI PUNTA COMUNQUE ALLO STORICO, AL MAX S VUOTO
