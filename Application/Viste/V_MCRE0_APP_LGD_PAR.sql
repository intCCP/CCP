CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_LGD_PAR AS
SELECT
...
CASE
  ...
  ELSE NULL
END DESC_TIPO_GAR
FROM T_MCRE0_APP_LGD_PAR;

GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_LGD_PAR TO MCRE_APP;
GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_LGD_PAR TO MCRE_USR;
CREATE OR REPLACE PUBLIC SYNONYM V_MCRE0_APP_LGD_PAR FOR MCRE_OWN.V_MCRE0_APP_LGD_PAR;