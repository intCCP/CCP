/* Formatted on 21/07/2014 18:38:45 (QP5 v5.227.12220.39754) */
...
AS
 ...
 -- 15.10.2012   V.4.2 TOLTE STIME EXTRA -- LA PAGINA DI EXTRA DELIBERA NON COMPORTA LA SCRITTURA NELLA STIME EXTRA
             ...
             FROM v_mcre0_app_upd_fields uf,
                  -- 20.05.2014   V.4.3 Filtro per scartare gli incagli forfettari
                  t_mcre0_app_pcr p,
            ...
            WHERE     flg_target = 'Y'
                  ...
                  AND uf.id_utente != -1
                  AND uf.cod_abi_cartolarizzato = p.cod_abi_cartolarizzato
                  AND uf.cod_ndg = p.cod_ndg
                  AND uf.cod_abi_cartolarizzato = DO.val_dominio(+)
                  AND DO.cod_dominio(+) = 'LIM_INC_FORF'
                  AND p.scsb_uti_cassa > DO.desc_dominio)
