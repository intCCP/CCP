/* Formatted on 21/07/2014 18:44:59 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VNMCRE0_APP_ALERT_FIDI
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
...
AS
   SELECT /*+ordered no_parallel(a) no_parallel(p)*/
         ...
         P.DTA_ULTIMA_REVISIONE dta_scadenza_revisione_fidi
    FROM t_mcre0_app_alert_pos a, t_mcre0_app_pef p, --  MV_MCRE0_app_istituti i,
