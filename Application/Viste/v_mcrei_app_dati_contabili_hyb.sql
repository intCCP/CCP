/* Formatted on 21/07/2014 18:39:18 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DATI_CONTABILI_HYB
(
...
AS
   SELECT v.cod_abi_cartolarizzato,
     ...
     FROM (  SELECT a.cod_abi_cartolarizzato,
                    ...
                    --mm1016 ripristino calcolo data
                    ...
                    CASE
                       ...
                       THEN      --regola rio, + seonda proroga se già scaduta
                          CASE
                             WHEN (dta_servizio + c.val_gg_prima_proroga) <
                                     SYSDATE
                             THEN
                                TRUNC (SYSDATE) + c.val_gg_seconda_proroga
                             ELSE
