/* Formatted on 21/07/2014 18:47:03 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.X_MCRES_SPESE_ITF
(
   ID_DOCUMENTO,
   ID_DPER,
   COD_ABI,
...
AS
               SELECT                    --  20121008    AG  Created this view
                               --  20121009    AG  Modifica nomenclatura campi
                                         --  20121025    AG  decode su cod_abi
                      id_documento,
                      id_dper,
                 ...
                 FROM XMLTABLE (
                         ...
                         COLUMNS id_documento VARCHAR2 (255) PATH 'IdDocumento',
                                 ...
                                 val_numero_fattura VARCHAR2 (512) PATH 'Val_NumeroFattura',
                                 ...
                                 val_causa_importo VARCHAR2 (512) PATH 'Val_Causa_Importo',
                                 ...
                                 val_ente_pagatore VARCHAR2 (512) PATH 'Val_Ente_Pagatore',
                                 ...
                                 val_imp_contrprev VARCHAR2 (512) PATH 'Val_Imp_Contrprev',
