/* Formatted on 21/07/2014 18:33:14 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_ARCHIVIO_NEW
(
   DTA_UPD,
   COD_RAMO_CALCOLATO,
   COD_DIVISIONE,
         ...
         TO_CHAR (SYSDATE, 'DDMMYY') DTA_UPD,
          ...
          CASE
             ...
             ELSE
                NULL
          END
             COD_COMPARTO, -- LF modifica per oscurare cognome e comparto in caso di stato non gestito
          --            XX.COD_COMPARTO,
          ...
          CASE
             ...
             ELSE
                NULL
          END
             COGNOME, -- LF modifica per oscurare cognome e comparto in caso di stato non gestito
          --            XX.COGNOME,
