/* Formatted on 21/07/2014 18:45:32 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VNMCRE0_APP_SCHEDA_ANAG_GE
(
...
AS
   SELECT /*+  no_parallel(cr)   */
    ...
    WHERE     GE.FLG_CAPOGRUPPO = 'S'
          ...
          AND GE.COD_SNDG = CR.GEGB_COD_SNDG;
