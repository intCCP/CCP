/* Formatted on 21/07/2014 18:30:13 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.O_MCRE0_APP_COMUNIC_NEW_ALERT
(
...
AS
   SELECT                                           /*ordered noparallel(a) */
    ...
    WHERE                                        --  f.id_utente = u.id_utente
              ...
              f.cod_abi_cartolarizzato = s.cod_abi_cartolarizzato
