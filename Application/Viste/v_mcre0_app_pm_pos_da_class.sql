...
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_PM_POS_DA_CLASS
(
   ID_UTENTE,
   ID_REFERENTE,
   COD_COMPARTO,
...
AS
   SELECT                           -- VG 20140702 cod_tipo_piano diverso da L
         a.ID_UTENTE,
          ...
          P.DTA_STATO_PROPOSTO DTA_RICHIESTA,
          P.COD_STATO_PROPOSTO COD_STATO_DECISO,
          p.ID_WORKFLOW,
          p.DTA_SCADENZA
    ...
    WHERE     a.COD_ABI_CARTOLARIZZATO = p.COD_ABI_CARTOLARIZZATO
          ...
          AND P.ID_WORKFLOW = 40                              --stato proposto
          AND p.COD_STATO_PROPOSTO IS NOT NULL
