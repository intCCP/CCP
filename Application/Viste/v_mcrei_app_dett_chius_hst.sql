/* Formatted on 21/07/2014 18:39:43 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DETT_CHIUS_HST
(
   COD_ABI,
   COD_NDG,
...
AS
   SELECT                                --0221 introdotta nuova pcr_rapp_aggr
     ...
     FROM t_mcrei_hst_delibere d,
          ...
          t_mcrei_hst_pratiche a,
          t_mcrei_cl_domini DO,
          t_mcrei_hst_pareri pa,
