/* Formatted on 21/07/2014 18:46:54 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.X_MCRE0_APP_ALERT_CNT
(
   ID_UTENTE,
   ID_REFERENTE,
...
AS
   ...
   UNION
     SELECT ID_UTENTE,
            ...
            --
            NVL (SUM (CNT_XS_V), 0) AS XS_V,
            --          'G' GIALLO,
            NVL (SUM (CNT_XS_G), 0) AS XS_A,
            --          'V' VERDE,
            NVL (SUM (CNT_XS_R), 0) AS XS_R,
            --          'R' ROSSO,
            ...
            NVL (SUM (CNT_RI_V), 0) AS RI_V,
            --          'G' GIALLO,
            NVL (SUM (CNT_RI_G), 0) AS RI_A,
            --          'V' VERDE,
            NVL (SUM (CNT_RI_R), 0) AS RI_R,
       ...
       FROM (  SELECT ID_ALERT_DA_ESPORRE,
                      ...
                      SUM (
                         CASE
                            WHEN ALERT = 'R' AND P.COD_STATO = 'GB' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_GB_R,
                      -- GIALLO,
                      SUM (
                         CASE
                            WHEN ALERT = 'G' AND P.COD_STATO = 'GB' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_GB_G,
                      -- VERDE,
                      SUM (
                         CASE
                            WHEN ALERT = 'V' AND P.COD_STATO = 'GB' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_GB_V,
                      -- GIALLO,
                      SUM (
                         CASE
                            WHEN ALERT = 'G' AND P.COD_STATO = 'PT' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_PT_G,
                      -- VERDE,
                      SUM (
                         CASE
                            WHEN ALERT = 'V' AND P.COD_STATO = 'PT' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_PT_V,
                      SUM (
                         CASE
                            WHEN ALERT = 'R' AND P.COD_STATO = 'PT' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_PT_R,
                      SUM (
                         CASE
                            WHEN ALERT = 'R' AND P.COD_STATO = 'RIO' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_RIO_R,
                      -- GIALLO,
                      SUM (
                         CASE
                            WHEN ALERT = 'G' AND P.COD_STATO = 'RIO' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_RIO_G,
                      -- VERDE,
                      SUM (
                         CASE
                            WHEN ALERT = 'V' AND P.COD_STATO = 'RIO' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_RIO_V,
                      SUM (
                         CASE
                            WHEN ALERT = 'R' AND P.COD_STATO = 'XS' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_XS_R,
                      -- GIALLO,
                      SUM (
                         CASE
                            WHEN ALERT = 'G' AND P.COD_STATO = 'XS' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_XS_G,
                      -- VERDE,
                      SUM (
                         CASE
                            WHEN ALERT = 'V' AND P.COD_STATO = 'XS' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_XS_V,
                      -- ROSSO,
                      SUM (
                         CASE
                            WHEN ALERT = 'R' AND P.COD_STATO = 'IN' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_IN_R,
                      -- GIALLO,
                      SUM (
                         CASE
                            WHEN ALERT = 'G' AND P.COD_STATO = 'IN' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_IN_G,
                      -- VERDE,
                      SUM (
                         CASE
                            WHEN ALERT = 'V' AND P.COD_STATO = 'IN' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_IN_V,
                      -- ROSSO,
                      SUM (
                         CASE
                            WHEN ALERT = 'R' AND P.COD_STATO = 'RS' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_RI_R,
                      -- GIALLO,
                      SUM (
                         CASE
                            WHEN ALERT = 'G' AND P.COD_STATO = 'RS' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_RI_G,
                      -- VERDE,
                      SUM (
                         CASE
                            WHEN ALERT = 'V' AND P.COD_STATO = 'RS' THEN 1 --VAL_CNT_RAPPORTI
                            ELSE 0
                         END)
                         CNT_RI_V
                 -- ROSSO,
   ...
   UNION
     SELECT ID_UTENTE,
            ...
            VAL_ORDINE_A,
            VAL_ORDINE_E,
            NVL (SUM (cnt_GB_R), 0) AS BO_R,
            NVL (SUM (cnt_GB_g), 0) AS BO_A,
            NVL (SUM (cnt_GB_v), 0) AS BO_V,
            NVL (SUM (cnt_PT_R), 0) AS PT_R,
            NVL (SUM (cnt_PT_g), 0) AS PT_A,
            NVL (SUM (cnt_PT_v), 0) AS PT_V,
            NVL (SUM (cnt_RIO_R), 0) AS RIO_R,
