/* Formatted on 21/07/2014 18:43:23 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_TIPO_DEL_VALIDE_BK
(
   COD_ABI,
   COD_DELIBERA,
   DESC_DELIBERA,
...
AS
   SELECT                          --  AG 05/07/2012 Aggiunta join con cod_abi
         cod_abi,
          COD_DELIBERA,
          DESC_DELIBERA,
          val_ordine
     FROM (SELECT a.*,
            ...
            WHERE cod_abi =
                     SUBSTR (SYS_CONTEXT ('userenv', 'client_info'), 16, 5)) TIPO
