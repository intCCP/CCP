/* Formatted on 21/07/2014 18:45:41 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VOMCRE0_APP_ALERT_CNT
(
   ID_UTENTE,
   ID_REFERENTE,
     ...
     FROM (  SELECT -- v1.0 06/04/2011 V.Galli Nuova versione per migliore performance + privilegi e ordinamento
               ...
               FROM (SELECT DISTINCT
                       ...
                       FROM (SELECT DISTINCT
                                    ...
                                    s.cod_macrostato cod_stato_precedente,
                                    alert_1,
                                    DECODE (
                                       alert_1,
                                       NULL, TO_NUMBER (NULL),
