/* Formatted on 21/07/2014 18:42:35 (QP5 v5.227.12220.39754) */
...
AS
   SELECT             -- 20120928 AG  Inclusi piani extra (e rapporti leading)
    ...
    WHERE     0 = 0
          ...
          AND r.cod_protocollo_delibera = p.cod_protocollo_delibera;
