/* Formatted on 21/07/2014 18:45:03 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VNMCRE0_APP_ALERT_POS
(
...
AS
   SELECT /*+ordered no_parallel(a) no_parallel(up)*/
