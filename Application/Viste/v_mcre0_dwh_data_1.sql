/* Formatted on 21/07/2014 18:36:57 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_DWH_DATA_1
(
   TODAY_FLG,
   COD_ABI_ISTITUTO,
...
AS
   SELECT                                                         -- flg today
         NVL (
          ...
          F.COD_SNDG,
          --anagrafiche
          GE.VAL_ANA_GRE AS DESC_GRUPPO_ECONOMICO,
          A.DTA_RIF_PD_ONLINE,
          A.VAL_RATING_ONLINE,
          A.VAL_PD_ONLINE,
          ...
          CR.GLGB_QIS_UTI,
          CR.GLGB_DTA_RIF_CR
     FROM T_MCRE0_DWH_AGRU A,
          T_MCRE0_DAY_FG F,
          T_MCRE0_DWH_AGRE GE,
          T_MCRE0_DWH_PEF PE,
          T_MCRE0_DWH_IRIS IRIS,
          T_MCRE0_DWH_XRA X,
          T_MCRE0_DWH_SAG S,
          V_MCRE0_W_ALL_PCR P,
          V_MCRE0_W_ALL_CR CR
    WHERE     F.COD_SNDG = A.COD_SNDG
          ...
          AND (   p.FLG_FLUSSO_GB = 1
               OR p.FLG_FLUSSO_GE_SB = 1
               OR p.FLG_FLUSSO_SC_SB = 1);
