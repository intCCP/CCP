...
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_WRK_SPL_AZIONI_GIUD
(
   LINE
)
AS
   SELECT    LPAD (NVL (TO_CHAR (val_anno_pratica), '0'), 4, '0') -- val_anno_pratica
          ...
          || NVL (
                TO_CHAR (dta_completamento_azione, 'DD/MM/YYYY HH24.mi.ss'),
