CREATE TABLE MCRE_OWN.T_MCRE0_SC_VINCOLI_LGD_PAR(
ID_FLUSSO                  NUMBER,
ID_DPER                    NUMBER(8), 
...
CREATE INDEX MCRE_OWN.IX_T_MCRE0_SC_VINC_LGD_PAR_01 ON MCRE_OWN.T_MCRE0_SC_VINCOLI_LGD_PAR(ID_FLUSSO) TABLESPACE TSI_MCRE_OWN;
CREATE INDEX MCRE_OWN.IX_T_MCRE0_SC_VINC_LGD_PAR_02 ON MCRE_OWN.T_MCRE0_SC_VINCOLI_LGD_PAR(ID_DPER) TABLESPACE TSI_MCRE_OWN;

GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_SC_VINCOLI_LGD_PAR TO MCRE_APP;
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_SC_VINCOLI_LGD_PAR TO MCRE_USR;

CREATE PUBLIC SYNONYM T_MCRE0_SC_VINCOLI_LGD_PAR FOR MCRE_OWN.T_MCRE0_SC_VINCOLI_LGD_PAR;
