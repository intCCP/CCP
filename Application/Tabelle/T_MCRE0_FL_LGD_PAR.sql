CREATE TABLE MCRE_OWN.T_MCRE0_FL_LGD_PAR(
ID_DPER         NUMBER(8), 
...
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_FL_LGD_PAR TO MCRE_APP;
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_FL_LGD_PAR TO MCRE_USR;

CREATE PUBLIC SYNONYM T_MCRE0_FL_LGD_PAR FOR MCRE_OWN.T_MCRE0_FL_LGD_PAR;
