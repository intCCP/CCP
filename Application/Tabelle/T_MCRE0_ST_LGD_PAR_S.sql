CREATE TABLE MCRE_OWN.T_MCRE0_ST_LGD_PAR_S(
ID_DPER                    NUMBER(8),
...
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_ST_LGD_PAR_S TO MCRE_APP;
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_ST_LGD_PAR_S TO MCRE_USR;

CREATE PUBLIC SYNONYM T_MCRE0_ST_LGD_PAR_S FOR MCRE_OWN.T_MCRE0_ST_LGD_PAR_S;
