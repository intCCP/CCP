CREATE TABLE MCRE_OWN.TE_MCREI_LGD_GRI_S (
...
(
  ...
  ( 
    ...
    BADFILE 'D_MCRE0_BAD':'LGD_GRI_S.bad'
    NODISCARDFILE
    LOGFILE 'D_MCRE0_LOG':'LGD_GRI_S.log'
    FIELDS
  ...
  LOCATION 
  ( 
    D_MCREI_WORK: 'LGD_GRI_S.01010'
  , D_MCREI_WORK: 'LGD_GRI_S.01025'
  , D_MCREI_WORK: 'LGD_GRI_S.03059'
  , D_MCREI_WORK: 'LGD_GRI_S.03239'
  , D_MCREI_WORK: 'LGD_GRI_S.03240'
  , D_MCREI_WORK: 'LGD_GRI_S.03249'
  , D_MCREI_WORK: 'LGD_GRI_S.03296'
  , D_MCREI_WORK: 'LGD_GRI_S.03309'
  , D_MCREI_WORK: 'LGD_GRI_S.03359'
  , D_MCREI_WORK: 'LGD_GRI_S.05748'
  , D_MCREI_WORK: 'LGD_GRI_S.06010'
  , D_MCREI_WORK: 'LGD_GRI_S.06065'
  , D_MCREI_WORK: 'LGD_GRI_S.06080'
  , D_MCREI_WORK: 'LGD_GRI_S.06125'
  , D_MCREI_WORK: 'LGD_GRI_S.06130'
  , D_MCREI_WORK: 'LGD_GRI_S.06160'
  , D_MCREI_WORK: 'LGD_GRI_S.06165'
  , D_MCREI_WORK: 'LGD_GRI_S.06225'
  , D_MCREI_WORK: 'LGD_GRI_S.06260'
  , D_MCREI_WORK: 'LGD_GRI_S.06280'
  , D_MCREI_WORK: 'LGD_GRI_S.06315'
  , D_MCREI_WORK: 'LGD_GRI_S.06340'
  , D_MCREI_WORK: 'LGD_GRI_S.06345'
  , D_MCREI_WORK: 'LGD_GRI_S.06380'
  , D_MCREI_WORK: 'LGD_GRI_S.06385'
  , D_MCREI_WORK: 'LGD_GRI_S.06930'
  , D_MCREI_WORK: 'LGD_GRI_S.10637' 
  ) 
)
REJECT LIMIT UNLIMITED;

GRANT SELECT ON MCRE_OWN.TE_MCREI_LGD_GRI_S TO MCRE_APP;
GRANT SELECT ON MCRE_OWN.TE_MCREI_LGD_GRI_S TO MCRE_USR;
CREATE PUBLIC SYNONYM TE_MCREI_LGD_GRI_S FOR MCRE_OWN.TE_MCREI_LGD_GRI_S;
