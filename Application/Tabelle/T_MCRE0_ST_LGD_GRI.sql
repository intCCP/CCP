CREATE TABLE MCRE_OWN.T_MCRE0_ST_LGD_GRI(
ID_DPER         NUMBER(8), 
...
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_ST_LGD_GRI TO MCRE_APP;
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_ST_LGD_GRI TO MCRE_USR;

CREATE PUBLIC SYNONYM T_MCRE0_ST_LGD_GRI FOR MCRE_OWN.T_MCRE0_ST_LGD_GRI;
