CREATE TABLE MCRE_OWN.T_MCRE0_SC_CONVERT_LGD_PAR_S(
ID_FLUSSO         NUMBER,
...
CREATE INDEX MCRE_OWN.IX_T_MCRE0_SC_CNV_LGD_PAR_S_1 ON MCRE_OWN.T_MCRE0_SC_CONVERT_LGD_PAR_S(ID_FLUSSO) TABLESPACE TSI_MCRE_OWN;
CREATE INDEX MCRE_OWN.IX_T_MCRE0_SC_CNV_LGD_PAR_S_2 ON MCRE_OWN.T_MCRE0_SC_CONVERT_LGD_PAR_S(ID_DPER) TABLESPACE TSI_MCRE_OWN;

GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_SC_CONVERT_LGD_PAR_S TO MCRE_APP;
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_SC_CONVERT_LGD_PAR_S TO MCRE_USR;

CREATE PUBLIC SYNONYM T_MCRE0_SC_CONVERT_LGD_PAR_S FOR MCRE_OWN.T_MCRE0_SC_CONVERT_LGD_PAR_S;
