CREATE TABLE MCRE_OWN.T_MCRE0_FL_LGD_GRI_S(
ID_DPER         NUMBER(8), 
...
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_FL_LGD_GRI_S TO MCRE_APP;
GRANT SELECT,INSERT,UPDATE,DELETE ON MCRE_OWN.T_MCRE0_FL_LGD_GRI_S TO MCRE_USR;

CREATE PUBLIC SYNONYM T_MCRE0_FL_LGD_GRI_S FOR MCRE_OWN.T_MCRE0_FL_LGD_GRI_S;
