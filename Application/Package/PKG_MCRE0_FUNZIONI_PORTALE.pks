CREATE OR REPLACE PACKAGE BODY          pkg_mcre0_funzioni_portale AS
  /******************************************************************************
   ...
   10.0        14/07/2014        M.Murro      PM: fix gestione bonis e AV
  ******************************************************************************/
...
--         AND cod_stato NOT IN ('SO', 'IN');
    ...
    SELECT COUNT(*)
     ...
     WHERE cod_abi_cartolarizzato = p_abi_cart
       AND cod_ndg = p_ndg
       and flg_stato = 0;--v10.0 non considero avocazioni concluse!
  ...
  --OBSOLETO-- SI USA SOLO AVOCAZIONE
...
if p_esito = 1 then
--v10.0 estendo disassegnazione a qualsiasi livello
