  ...
  CREATE OR REPLACE FORCE VIEW "MCRE_OWN"."V_MCREI_APP_QUADRO_SINT_SNDG" ("COD_PROTOCOLLO_PACCHETTO", "COD_MICROTIPOLOGIA_DELIB", "COD_PROTOCOLLO_DELIBERA", "COD_FASE_PACCHETTO", "COD_FASE_MICROTIPOLOGIA", "COD_ABI", "COD_NDG", "COD_SNDG", "DESC_ISTITUTO", "VAL_RET_DELIBERATA_CASSA", "VAL_RET_DELIBERATA_FIRMA", "VAL_RET_DELIBERATA_DERIVATI", "VAL_RET_PROPOSTA_CASSA", "VAL_RET_PROPOSTA_FIRMA", "VAL_RET_PROPOSTA_DERIVATI", "VAL_RET_TOT_DA_DELIB_CASSA", "VAL_RET_TOT_DA_DELIB_FIRMA", "VAL_RET_TOT_DA_DELIB_DERIVATI", "TOT_RETTIFICA_DA_DELIB", "VAL_RDV_TOT_CASSA", "VAL_RDV_TOT_FIRMA", "VAL_RDV_TOT_DERIVATI", "VAL_RDV_TOT", "VAL_RINUNCIA_PREGRESSA", "VAL_RINUNCIA_PROPOSTA", "TOT_RINUNCIA_DA_DELIB", "DTA_SCAD_VARIAZIONE_PROPOSTA", "DTA_SCAD_TOT_DA_DELIBERARE", "COD_ORGANO_CALCOLATO", "COD_OD_EFFETTIVO", "DTA_DELIBERA", "DTA_DELIBERA_RETE", "DTA_CONFERMA_DELIBERA", "FLG_COERENZA_CON_PARERE", "DESC_NOTE_COERENZA", "VAL_RDV_DELIB_BANCA_RETE", "COD_FASE_DELIBERA", "VAL_STRALCIO_QUOTA_CAP", "VAL_STRALCIO_QUOTA_MORA", "DTA_AGGIORNAMENTO_STATO", "FLG_CONFERMA", "COD_DOC_DELIBERA_BANCA", "COD_DOC_PARERE_CONFORMITA", "COD_DOC_APPENDICE_PARERE", "COD_DOC_DELIBERA_CAPOGRUPPO", "COD_DOC_CLASSIFICAZIONE", "COD_MACROTIPOLOGIA_DELIB", "VAL_RINUNCIA_CAPITALE", "VAL_RINUNCIA_MORA", "DTA_LAST_UPD_DELIBERA", "COD_TIPO_PACCHETTO", "FLG_RISTRUTTURATO", "COD_DELIBERA_MODIFICATO", "COD_GRUPPO_SUPER", "DTA_CONFERMA_PACCHETTO", "DESC_NOME_CONTROPARTE","COD_DOC_CLASSIFICAZIONE_MCI") AS 
