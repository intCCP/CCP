CREATE OR REPLACE PACKAGE BODY MCRE_OWN.parse
IS
...
CREATE SYNONYM MCRE_APP.PARSE FOR MCRE_OWN.PARSE;


CREATE SYNONYM MCRE_USR.PARSE FOR MCRE_OWN.PARSE;


GRANT EXECUTE, DEBUG ON MCRE_OWN.PARSE TO MCRE_USR;
