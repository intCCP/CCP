...
******************************************************************************/
   ...
   BEGIN
      ...
      sttime := SYSDATE;
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'pschema: '||pschema );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'ptable: '||ptable );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'ppartition: '||ppartition );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'v_estimatepercent: '||v_estimatepercent );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'pbsample: '||v_blocksample );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'v_methodoption: '||v_methodoption );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'pdegree: '||pdegree );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'v_granularity: '||v_granularity );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'pcascade: '||v_cascade );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'pinvalidate: '||v_invalidate );
        PKG_MCRE0_LOG.SPO_MCRE0_LOG_EVENTO ( -777, procedura, esito_ok, 'pforce: '||v_force );  
