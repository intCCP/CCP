CREATE OR REPLACE PACKAGE MCRE_OWN.PKG_MCRE0_ESTENDI_fileguida2 AS
/******************************************************************************
...
******************************************************************************/
c_package CONSTANT VARCHAR2 (50) := 'PKG_MCRE0_ESTENDI_fileguida2';
c_fileguida2 CONSTANT VARCHAR2(45) := 'FILE_GUIDA';
c_tavoli CONSTANT VARCHAR2(6) := '011901';
--lancia in sequenza le procedure seguenti
...
-- valorizzo i campi codice Gruppo Economico e Gruppo Legame e parte del codice collegamento
