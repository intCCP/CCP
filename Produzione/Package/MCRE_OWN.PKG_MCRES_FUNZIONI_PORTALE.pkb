...
FUNCTION fnc_aggiorna_stato_spesa(
  ...
  RETURN NUMBER
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ  parametri input per stato AN';
  ...
  utente := p_cod_operatore_ins_upd;
    ...
    INTO t_mcres_app_rapporti
      ...
      (
        ...
        --AP 12/10/2012 CABLATO COD_DIVISA A 'EUR' PERCHÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ¿ I RAPPORTI INSERITI DA CRUSSOTTO HANNO SEMPRE COD_DIVISA = EUR
        'EUR', --P_COD_DIVISA
        P_COD_FORMA_TECNICA ,
        P_COD_NDG ,
        ...
        P_COD_RAPPORTO ,
        P_COD_SNDG ,
        --AP 12/10/2012 CABLATO COD_SSA A MO PERCHÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ¿ I RAPPORTI INSERITI DA CRUSSOTTO HANNO SEMPRE COD_SSA = MO
        'MO', --P_COD_SSA
...
BEGIN
  ...
  --
      ...
      ******************/
      ...
      --AP 13112013 commentato perchÿￜÿￜÿￜÿ¡ ho aggiunto chiamata funzione generazione cod_Autorizzazione
...
/*
    AG 20120803
        ...
        then
            pkg_mcres_audit.log_app(c_nome,pkg_mcres_audit.c_error,sqlcode,sqlerrm,'Impossibile variare lo stato. Delibera giÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ¿ÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ  confermata' ,p_utente);
            return ko;
        end if;
*/
    exception
...
begin
    ...
    v_note := 'controllo validitaÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ  parametri input';
    if
        p_cod_abi is null or
        p_cod_ndg is null or
...
begin
    ...
    v_note := 'Controllo validitÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ¿ÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ  parametri input';
    if
        p_cod_abi is null or
        p_cod_ndg is null or
        p_cod_rapporto is null or
...
begin
    ...
    v_note := 'Controllo validitÿￜÿￜÿￜÿ¯ÿￜÿￜÿￜÿ¿ÿￜÿￜÿￜÿ¿arametri di input';
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ  parametri input';
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿￜÿￜÿￜÿￜÿ valorizzazione id_alert input';
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ valorizzazione soglie';
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ valorizzazione cod_abi input';
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ esistenza istituto';
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ valorizzazione parametri input';
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ valorizzazione cod_tipo_scadenza input';
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ esistenza voce scadenzario';
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ esistenza proroga - ABI='||p_cod_abi||' PROTOCOLLO='||p_cod_protocollo||' DTA_ISRT='||p_dta_isrt_proroga;
    select count(*)
    into v_exists
...
begin
    ...
    v_note := 'Controlloÿￜÿￜÿￜÿ esistenza rapporto delibera - ABI='||p_cod_abi||' PROTOCOLLO='||p_cod_protocollo||' UO_CNTRT='||p_cod_uo_cntrt||' PROD_CNTRT='||p_cod_prod_cntrt;
    select count(*)
    into v_exists
