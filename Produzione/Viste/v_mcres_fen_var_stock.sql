/* Formatted on 17/06/2014 18:13:12 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_FEN_VAR_STOCK
(
   COD_ABI,
   ID_DPER,
   DTA_RIF,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_FEN_VAR_STOCK TO MCRE_USR;
