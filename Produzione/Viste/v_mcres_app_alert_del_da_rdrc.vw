/* Formatted on 17/06/2014 18:09:16 (QP5 v5.227.12220.39754) */
...
AS
   SELECT A.*, c.id_object AS id_object_al_tr, d.id_object AS id_object_al_co
...
GRANT SELECT ON MCRE_OWN.V_MCRES_APP_ALERT_DEL_DA_RDRC TO MCRE_USR;
