/* Formatted on 17/06/2014 18:10:59 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_QUARTERS
(
   COD_Q,
   DTA_START_Q,
   DTA_END_Q,
...
GRANT SELECT ON MCRE_OWN.V_MCRES_APP_QUARTERS TO MCRE_USR;
