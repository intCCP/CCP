/* Formatted on 17/06/2014 18:09:24 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_ALERT_DOC_DA_RACC
(
   ID_ALERT,
   COD_ABI,
   COD_NDG,
   ...
   SELECT                                                   -- 20131106 VG New
     ...
     FROM (SELECT p.cod_abi,
          ...
          (SELECT DISTINCT
            ...
            WHERE cod_uo_rapporto IS NOT NULL) uo
    WHERE     1 = 1
...
GRANT SELECT ON MCRE_OWN.V_MCRES_APP_ALERT_DOC_DA_RACC TO MCRE_USR;
