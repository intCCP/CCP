/* Formatted on 17/06/2014 18:10:24 (QP5 v5.227.12220.39754) */
...
AS
   SELECT SUBSTR (s.cod_autorizzazione, 1, 4) cod_societa_sap,
    ...
    WHERE     0 = 0
          ...
          AND al.cod_tipo_del_spesa IN ('1', '6')
   ...
   SELECT SUBSTR (s.cod_autorizzazione, 1, 4) cod_societa_sap,
    ...
    WHERE     0 = 0
          ...
          AND s.cod_autorizzazione_padre IS NULL
          ---
          AND do.cod_tipo_del_spesa IN ('1', '6')
...
GRANT SELECT ON MCRE_OWN.V_MCRES_APP_EXTRACT_FROM_DOC TO MCRE_USR;
