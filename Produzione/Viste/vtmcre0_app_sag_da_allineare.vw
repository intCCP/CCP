/* Formatted on 17/06/2014 18:17:01 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_SAG_DA_ALLINEARE
(
   VAL_ALERT,
   DTA_INS_ALERT,
   COD_SNDG,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_SAG_DA_ALLINEARE TO MCRE_USR;
