/* Formatted on 17/06/2014 18:10:18 (QP5 v5.227.12220.39754) */
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_APP_ELENCOPR_APERTE TO MCRE_USR;
