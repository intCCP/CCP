/* Formatted on 17/06/2014 18:00:18 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_ALERT_NUOVE_SOFF
(
   VAL_ALERT,
   DTA_INS_ALERT,
   VAL_ORDINE_COLORE,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_ALERT_NUOVE_SOFF TO MCRE_USR;
