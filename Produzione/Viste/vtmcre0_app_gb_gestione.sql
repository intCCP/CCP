/* Formatted on 17/06/2014 18:15:53 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_GB_GESTIONE
(
...
AS
   SELECT                                                -- MM 26-04-2011 v1.0
    ...
    WHERE     GB.COD_ABI_CARTOLARIZZATO = F.COD_ABI_CARTOLARIZZATO(+)
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_GB_GESTIONE TO MCRE_USR;
