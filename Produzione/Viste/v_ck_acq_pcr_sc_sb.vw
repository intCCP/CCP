/* Formatted on 17/06/2014 17:59:40 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_CK_ACQ_PCR_SC_SB
...
GRANT SELECT ON MCRE_OWN.V_CK_ACQ_PCR_SC_SB TO MCRE_USR;
