/* Formatted on 17/06/2014 18:14:54 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ALERT_OD_INFERIORE
(
   VAL_ALERT,
   DTA_INS_ALERT,
   VAL_ORDINE_COLORE,
...
AS
   SELECT DISTINCT
    ...
    WHERE     ad.TODAY_FLG = '1'
          AND al.cod_abi = ad.cod_abi_cartolarizzato
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ALERT_OD_INFERIORE TO MCRE_USR;
