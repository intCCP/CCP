/* Formatted on 17/06/2014 17:58:49 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.MVTMCRE0_APP_UPD_FIELD
(
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.MVTMCRE0_APP_UPD_FIELD TO MCRE_USR;
