/* Formatted on 17/06/2014 18:14:41 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_AL_NEW_RAP_DARISTR
(
   VAL_ALERT,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_AL_NEW_RAP_DARISTR TO MCRE_USR;
