/* Formatted on 17/06/2014 18:17:32 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_WRK_AL_DELIB_DACONF_BR
(
   COD_SNDG,
   COD_ABI,
   COD_NDG,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_WRK_AL_DELIB_DACONF_BR TO MCRE_USR;
