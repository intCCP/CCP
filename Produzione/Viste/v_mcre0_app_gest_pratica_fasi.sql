/* Formatted on 17/06/2014 18:02:06 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_GEST_PRATICA_FASI
(
...
AS
   SELECT ad.cod_abi_cartolarizzato,
     ...
     FROM T_MCRE0_APP_GEST_PRATICA_FASI pf, T_MCRE0_APP_ALL_DATA ad
    WHERE     ad.cod_abi_cartolarizzato = pf.cod_abi_cartolarizzato
          AND ad.cod_ndg = pf.cod_ndg
          AND ad.today_flg = '1';


GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_GEST_PRATICA_FASI TO MCRE_USR;
