/* Formatted on 17/06/2014 18:16:59 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_RIO_SCHEMA_ESP
(
...
AS
   SELECT                                         -- V1 --/--/---- VG: Created
    ...
    FROM VTMCRE0_APP_UPD_FIELDS F, T_MCRE0_APP_PCR B
   WHERE     F.COD_ABI_CARTOLARIZZATO = B.COD_ABI_CARTOLARIZZATO(+)
         AND F.COD_NDG = B.COD_NDG(+);


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_RIO_SCHEMA_ESP TO MCRE_USR;
