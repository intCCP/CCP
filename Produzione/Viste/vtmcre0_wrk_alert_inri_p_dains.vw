/* Formatted on 17/06/2014 18:17:35 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_WRK_ALERT_INRI_P_DAINS
(
   COD_ABI,
   COD_NDG,
   COD_SNDG,
   ...
   SELECT cod_abi,
     ...
     FROM (SELECT d.cod_abi_cartolarizzato AS cod_abi,
                  ...
                  OVER (PARTITION BY de.cod_abi, de.cod_ndg
                     ...
                     AS rn
             FROM t_mcre0_app_all_data_DAY d,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_WRK_ALERT_INRI_P_DAINS TO MCRE_USR;
