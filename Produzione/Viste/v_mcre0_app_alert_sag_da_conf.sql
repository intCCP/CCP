/* Formatted on 17/06/2014 18:00:52 (QP5 v5.227.12220.39754) */
...
AS
   SELECT "VAL_ALERT",
          ...
          "FLG_ABI_LAVORATO",
          "VAL_UTI_TOT"
     FROM (SELECT /*+ordered no_parallel(a) no_parallel(t)*/
           ...
           WHERE     ALERT_1 IS NOT NULL
                 ...
                 AND X.COD_SNDG = T.COD_SNDG(+)) sg
    WHERE sg.r = 1;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_ALERT_SAG_DA_CONF TO MCRE_USR;
