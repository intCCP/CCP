/* Formatted on 17/06/2014 18:03:55 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_RIO_GRAFICO_E
(
...
AS
   SELECT X.COD_ABI_CARTOLARIZZATO,
    ...
    WHERE     COD_MACROSTATO = 'RIO'
          ...
          AND COD_AZIONE IN ('12', '13', '14')
          AND g.flg_delete = 0;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_RIO_GRAFICO_E TO MCRE_USR;
