/* Formatted on 17/06/2014 18:02:38 (QP5 v5.227.12220.39754) */
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_PT_POS_DA_CONV TO MCRE_USR;
