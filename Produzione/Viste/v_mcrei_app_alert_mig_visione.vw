/* Formatted on 17/06/2014 18:07:19 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_ALERT_MIG_VISIONE
(
   VAL_ALERT,
   ALERT,
   ID_ALERT,
...
AS
   SELECT DISTINCT
          ...
          -- nvl(d.val_rdv_qc_progressiva, 0) + nvl(val_rdv_progr_fi, 0) AS val_rdv_migrata,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_APP_ALERT_MIG_VISIONE TO MCRE_USR;
