/* Formatted on 17/06/2014 18:11:34 (QP5 v5.227.12220.39754) */
...
AS
   SELECT r.cod_abi,
    ...
    WHERE     p.flg_attiva = 1
          ...
          AND S.COD_PRODOTTO = T.COD_PRODOTTO(+)
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_APP_SP_RAPPORTI_DISPON TO MCRE_USR;
