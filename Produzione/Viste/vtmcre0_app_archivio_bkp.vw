/* Formatted on 17/06/2014 18:15:32 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ARCHIVIO_BKP
(
   DTA_UPD,
   COD_RAMO_CALCOLATO,
   COD_DIVISIONE,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ARCHIVIO_BKP TO MCRE_USR;
