/* Formatted on 17/06/2014 18:17:49 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCREI_APP_DELIB_GENERICHE
(
   COD_SNDG,
...
AS
   SELECT                                --0221 introdotta nuova pcr_rapp_aggr
    ...
    WHERE     d.cod_abi = f.cod_abi_cartolarizzato
          ...
          AND d.cod_fase_pacchetto NOT IN ('ANA', 'ANM')               --13dic
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCREI_APP_DELIB_GENERICHE TO MCRE_USR;
