/* Formatted on 17/06/2014 18:02:49 (QP5 v5.227.12220.39754) */
...
AS
     SELECT --SUBSTR(pos.cod_mese_hst,1,6) id_dper,  --cod_mese_hst è diventato o fine mese o 0 se delibere con fine validità nel mese
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_QDC_CDR_STORICO TO MCRE_USR;
