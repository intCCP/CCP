/* Formatted on 17/06/2014 18:16:12 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_POS_USCITE_RIPORT
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
...
AS
   SELECT ALERT_10 VAL_ALERT,
          ...
          X.DTA_LAST_RIPORTAF,
          A.ID_UTENTE_PRE
     FROM VTMCRE0_APP_ALERT_POS A, VTMCRE0_APP_UPD_FIELDS X
    WHERE     ALERT_10 IS NOT NULL
          AND X.COD_ABI_CARTOLARIZZATO = A.COD_ABI_CARTOLARIZZATO
          AND X.COD_NDG = A.COD_NDG;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_POS_USCITE_RIPORT TO MCRE_USR;
