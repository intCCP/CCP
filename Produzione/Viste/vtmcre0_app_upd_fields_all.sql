/* Formatted on 17/06/2014 18:17:20 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_UPD_FIELDS_ALL
(
   TODAY_FLG,
   FLG_ACTIVE,
...
AS
   SELECT                   /*---+INDEX_NOINDEX(P IX5_T_MCRE0_APP_ALL_DATA) */
         TODAY_FLG,
          ...
          SCSB_ACC_SOSTITUZIONI,
          SCSB_UTI_SOSTITUZIONI
     FROM VTMCRE0_APP_UPD_FIELDS_PALL P,
...
GRANT SELECT ON MCRE_OWN.VTMCRE0_APP_UPD_FIELDS_ALL TO MCRE_USR;
