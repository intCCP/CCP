/* Formatted on 17/06/2014 18:13:06 (QP5 v5.227.12220.39754) */
...
AS
     SELECT                                                    --AG 05/12/2011
      ...
      WHERE 1 = 1
   GROUP BY cod_abi, SUBSTR (id_dper, 1, 6), cod_label;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_FEN_SINTESI_GESTIONE TO MCRE_USR;
