/* Formatted on 17/06/2014 18:16:28 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_RICERCA_LIST_NDG
(
   COD_COMPARTO,
   COD_RAMO_CALCOLATO,
   COD_ABI_ISTITUTO,
...
AS
   SELECT                                               -- 111111 v1 - solo IN
     ...
     FROM vtmcre0_app_upd_fields_all x;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_RICERCA_LIST_NDG TO MCRE_USR;
