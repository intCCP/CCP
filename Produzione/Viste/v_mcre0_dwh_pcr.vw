/* Formatted on 17/06/2014 18:05:12 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_DWH_PCR
(
   TODAY_FLG,
   COD_ABI_ISTITUTO,
...
AS
   ...
   SELECT TODAY_FLG,
          ...
          GLGB_UTI_CONSEGNE_DT,
          GLGB_ACC_CONSEGNE_DT
     FROM t_mcre0_pcr_wrk;


GRANT SELECT ON MCRE_OWN.V_MCRE0_DWH_PCR TO MCRE_USR;
