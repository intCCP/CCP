/* Formatted on 17/06/2014 18:14:13 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VOMCRE0_APP_RIO_ESP_SC
(
...
AS
   SELECT                                                     -- V1 VG Created
         ...
         F.SCSB_QIS_ACC SCSB_QIS_ACC_PC,
         F.SCSB_QIS_UTI SCSB_QIS_UTI_PC,
         F.SCGB_QIS_ACC SCGB_QIS_ACC_PC,
         F.SCGB_QIS_UTI SCGB_QIS_UTI_PC,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.VOMCRE0_APP_RIO_ESP_SC TO MCRE_USR;
