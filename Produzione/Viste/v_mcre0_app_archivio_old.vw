/* Formatted on 17/06/2014 18:01:13 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_ARCHIVIO_OLD
(
   DTA_UPD,
   COD_RAMO_CALCOLATO,
   COD_DIVISIONE,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_ARCHIVIO_OLD TO MCRE_USR;
