/* Formatted on 17/06/2014 18:08:19 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_HP_PAST_DUE
(
   COD_ABI_ISTITUTO,
   DESC_ISTITUTO,
...
GRANT SELECT ON MCRE_OWN.V_MCREI_APP_HP_PAST_DUE TO MCRE_USR;
