/* Formatted on 17/06/2014 18:16:08 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_POS_ASSEGNATE
(
   COD_ABI_ISTITUTO,
...
AS
   SELECT                                          -- V1 22/12/2010 VG: Creata
          ...
          X.FLG_GIROCOMPARTO
     --------------------   VG - CIB/BDT - FINE --------------------
     FROM VTMCRE0_APP_UPD_FIELDS X, T_MCRE0_APP_GRUPPO_LEGAME LE
    WHERE     X.ID_UTENTE <> -1
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_POS_ASSEGNATE TO MCRE_USR;
