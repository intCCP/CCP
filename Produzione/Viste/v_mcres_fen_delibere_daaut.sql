/* Formatted on 17/06/2014 18:12:06 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_FEN_DELIBERE_DAAUT
(
   COD_ABI,
   COD_NDG,
   COD_SNDG,
...
AS
     SELECT P.COD_ABI,
      ...
      WHERE     P.COD_ABI = A.COD_ABI
            ...
            AND D.COD_STATO_DELIBERA IN ('IN', 'SA')
   GROUP BY P.COD_ABI,
            P.COD_NDG,
            A.COD_PRATICA,
            A.VAL_ANNO,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_FEN_DELIBERE_DAAUT TO MCRE_USR;
