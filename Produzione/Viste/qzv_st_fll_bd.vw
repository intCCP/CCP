/* Formatted on 17/06/2014 17:58:51 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.QZV_ST_FLL_BD
(
   COD_SRC,
   ID_DPER,
   COD_STATO_RISCHIO,
...
AS
   SELECT COD_SRC,
          ...
          '#' COD_AREA_BUSINESS,
          COD_STATO_GIURIDICO
     FROM (SELECT 'BD' COD_SRC FROM DUAL) src,
...
GRANT SELECT ON MCRE_OWN.QZV_ST_FLL_BD TO MCRE_USR;
