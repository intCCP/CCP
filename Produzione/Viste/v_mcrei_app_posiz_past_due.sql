/* Formatted on 17/06/2014 18:08:35 (QP5 v5.227.12220.39754) */
...
AS
   SELECT f.cod_abi_istituto,
          ...
          dta_scadenza_stato AS dta_scadenza_stato,
          --12 feb, AD. richiesta correzione da ilaria su segnalazione utente
          f.dta_servizio,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_APP_POSIZ_PAST_DUE TO MCRE_USR;
