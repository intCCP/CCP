/* Formatted on 17/06/2014 18:08:05 (QP5 v5.227.12220.39754) */
...
AS
   SELECT DISTINCT
          ...
          cod_protocollo_delibera AS cod_prot_delibera,
          --nvl(cod_prot_delibera,substr((sys_context('userenv', 'client_info')), 22, 17)) AS cod_prot_delibera,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_APP_DETT_RAPPORTI_GEM TO MCRE_USR;
