/* Formatted on 17/06/2014 18:16:15 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_PRATICA_LEGALE
(
   COD_ISTITUTO,
   DESC_ISTITUTO,
   COD_NDG,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_PRATICA_LEGALE TO MCRE_USR;
