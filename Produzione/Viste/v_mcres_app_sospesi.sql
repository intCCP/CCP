/* Formatted on 17/06/2014 18:11:26 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_SOSPESI
(
   COD_MATR_PRATICA,
   COD_PRATICA,
   COD_UO_PRATICA,
...
AS
   SELECT PR.COD_MATR_PRATICA,
          ...
          || Sp.Dta_Spesa
             ...
             AS "COD_SPESA",
          --Sp.Val_Numero_Fattura,
          SP.VAL_NUMERO Val_Numero_Fattura,
          Sp.Cod_Autorizzazione,
          --Sp.Dta_Autorizzazione,
          SP.DTA_SPESA Dta_Autorizzazione,
          Sp.Cod_Abi,
          Sp.Cod_Tipo_Autorizzazione,
          Sp.Cod_Stato,
          'Proposta' AS Stato,
          --Sp.Dta_Ins_Spesa,
          SP.DTA_SPESA Dta_Ins_Spesa,
          --Sp.Val_Importo_Valore AS Val_Importo,
          Sp.Val_Importo,
          (SELECT Pos.Flg_Art_498
             FROM T_Mcres_App_Posizioni Pos
     ...
     FROM T_Mcres_App_Spese Sp,                    -- T_Mcres_App_Sp_Spese Sp,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_APP_SOSPESI TO MCRE_USR;
