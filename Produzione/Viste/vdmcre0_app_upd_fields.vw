/* Formatted on 17/06/2014 18:13:45 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VDMCRE0_APP_UPD_FIELDS
(
   TODAY_FLG,
   FLG_ACTIVE,
...
AS
   SELECT                   /*---+INDEX_NOINDEX(P IX5_T_MCRE0_APP_ALL_DATA) */
     ...
     FROM VDMCRE0_APP_UPD_FIELDS_P1 P,
...
GRANT SELECT ON MCRE_OWN.VDMCRE0_APP_UPD_FIELDS TO MCRE_USR;
