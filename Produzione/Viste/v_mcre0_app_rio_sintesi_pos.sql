/* Formatted on 17/06/2014 18:04:05 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_RIO_SINTESI_POS
(
...
AS
   SELECT                          -- v1.1 aggiunti iris e strategia cred. pef
          ...
          -- v3 15/09/2011 VG: Agganciata CR per QIS
          -- v4 05/10/2012 VG: commentata where RIO
     ...
     FROM V_MCRE0_APP_UPD_FIELDS_P1 X,
          ...
          T_MCRE0_APP_IRIS I,
          T_MCRE0_APP_PEF E
    WHERE     1 = 1                               --  X.COD_MACROSTATO = 'RIO'
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_RIO_SINTESI_POS TO MCRE_USR;
