/* Formatted on 17/06/2014 18:17:41 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_WRK_ALERT_RETT_DISAL
(
   VAL_ALERT,
   COD_SNDG,
   COD_ABI,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_WRK_ALERT_RETT_DISAL TO MCRE_USR;
