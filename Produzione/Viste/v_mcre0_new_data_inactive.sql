/* Formatted on 17/06/2014 18:05:30 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_NEW_DATA_INACTIVE
(
   TODAY_FLG,
   FLG_ACTIVE,
   FLG_SOURCE,
...
AS
   SELECT "TODAY_FLG",
          ...
          "SCSB_ACC_SOSTITUZIONI",
          "SCSB_UTI_SOSTITUZIONI"
     FROM t_mcre0_all_data b
    WHERE     b.flg_active = '1'
          AND NOT EXISTS
                     (SELECT 1
                        FROM t_mcre0_web_data a
                       WHERE     a.cod_ndg = b.cod_ndg
                             AND a.cod_abi_cartolarizzato =
                                    b.cod_abi_cartolarizzato);


GRANT SELECT ON MCRE_OWN.V_MCRE0_NEW_DATA_INACTIVE TO MCRE_USR;
