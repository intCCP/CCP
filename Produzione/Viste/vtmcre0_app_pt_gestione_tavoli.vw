/* Formatted on 17/06/2014 18:16:17 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_PT_GESTIONE_TAVOLI
(
...
AS
   SELECT                    --v1.1 07.02.11 MM -- upd_field al posto di mople
     ...
     FROM T_MCRE0_APP_PT_GESTIONE_TAVOLI T, VTMCRE0_APP_UPD_FIELDS_P1 M
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_PT_GESTIONE_TAVOLI TO MCRE_USR;
