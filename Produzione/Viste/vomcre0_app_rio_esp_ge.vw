/* Formatted on 17/06/2014 18:14:08 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VOMCRE0_APP_RIO_ESP_GE
(
...
AS
   SELECT                                                     -- V1 VG Created
         ...
         F.GESB_QIS_ACC GESB_QIS_ACC_PC,
         F.GESB_QIS_UTI GESB_QIS_UTI_PC,
         F.GEGB_QIS_ACC GEGB_QIS_ACC_PC,
         F.GEGB_QIS_UTI GEGB_QIS_UTI_PC,
         F.GEGB_ACC_SIS GEGB_ACC_SIS_PC,
         F.GEGB_UTI_SIS GEGB_UTI_SIS_PC
    FROM MV_MCRE0_APP_RIO_ESP_GE D,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.VOMCRE0_APP_RIO_ESP_GE TO MCRE_USR;
