/* Formatted on 17/06/2014 18:14:36 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_ANAGRAFICA_GENERALE
(
   COD_ABI_ISTITUTO,
...
GRANT SELECT ON MCRE_OWN.VTMCRE0_ANAGRAFICA_GENERALE TO MCRE_USR;
