/* Formatted on 17/06/2014 18:04:45 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_ASSEGNA_REGIONI
(
   MX,
   ID_UTENTE_ASSEGNATO,
...
GRANT SELECT ON MCRE_OWN.V_MCRE0_ASSEGNA_REGIONI TO MCRE_USR;
