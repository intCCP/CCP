/* Formatted on 17/06/2014 17:59:33 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_CK_ACQ_IRIS
...
ELSE ''
 ...
 WHERE cod_file = 'IRIS'
  ...
  UNION SELECT 'EXTERNAL TABLE SENZA SCARTI',
...
GRANT SELECT ON MCRE_OWN.V_CK_ACQ_IRIS TO MCRE_USR;
