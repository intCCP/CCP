/* Formatted on 17/06/2014 18:15:31 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ARCHIVIO
(
   DTA_UPD,
   COD_RAMO_CALCOLATO,
   COD_DIVISIONE,
...
AS
   ...
   SELECT /*+ NOPARALLEL(xx) */
     ...
     FROM T_MCRE0_APP_TIPI_PORTAFOGLIO T,
          VTMCRE0_APP_UPD_FIELDS XX,
          VTMCRE0_ANAGRAFICA_GENERALE G,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ARCHIVIO TO MCRE_USR;
