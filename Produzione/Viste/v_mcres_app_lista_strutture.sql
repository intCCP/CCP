/* Formatted on 17/06/2014 18:10:33 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_LISTA_STRUTTURE
(
   COD_PRESIDIO,
   DESC_PRESIDIO,
   COD_STR_ORG_SUP,
...
AS
   SELECT COD_STRUTTURA_COMPETENTE cod_presidio,
    ...
    WHERE     cod_abi_istituto = '01025'
          AND NVL (dta_chiusura, TRUNC (SYSDATE) + 1) >= TRUNC (SYSDATE);


GRANT SELECT ON MCRE_OWN.V_MCRES_APP_LISTA_STRUTTURE TO MCRE_USR;
