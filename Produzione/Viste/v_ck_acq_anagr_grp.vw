/* Formatted on 17/06/2014 17:59:29 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_CK_ACQ_ANAGR_GRP
       ...
       FROM (SELECT step, id_flusso
               ...
               FROM (SELECT 'PKG_MCRE0_UTILS.FND_MCRE0_checkIn' AS step,
                            ...
                            (SELECT DISTINCT id_flusso
                                       ...
                                       WHERE cod_file = 'ANAGRAFICA_GRUPPO'
...
GRANT SELECT ON MCRE_OWN.V_CK_ACQ_ANAGR_GRP TO MCRE_USR;
