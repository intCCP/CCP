/* Formatted on 17/06/2014 18:12:21 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_FEN_MCRD_MAINSOFFGR
(
   RN,
   ID_DPER,
   COD_CLI_GE,
...
GRANT SELECT ON MCRE_OWN.V_MCRES_FEN_MCRD_MAINSOFFGR TO MCRE_USR;
