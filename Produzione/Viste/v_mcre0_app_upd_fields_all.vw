/* Formatted on 17/06/2014 18:04:34 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_ALL
(
   TODAY_FLG,
   FLG_ACTIVE,
...
AS
   SELECT                   /*---+INDEX_NOINDEX(P IX5_T_MCRE0_APP_ALL_DATA) */
         TODAY_FLG,
          ...
          SCSB_ACC_SOSTITUZIONI,
          SCSB_UTI_SOSTITUZIONI,
          P.COD_GRUPPO_SUPER_OLD                   --07/04/2014 aggiunto campo
     FROM V_MCRE0_APP_UPD_FIELDS_PALL P,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_ALL TO MCRE_USR;
