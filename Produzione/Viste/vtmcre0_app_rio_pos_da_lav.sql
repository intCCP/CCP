/* Formatted on 17/06/2014 18:16:57 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_RIO_POS_DA_LAV
(
   COD_SNDG,
...
AS
   SELECT                                    -- VG 11-03-2011 COD_ISTITUTO_SOA
          ...
          i.cod_istituto_soa,
          x.cod_livello
     FROM vtmcre0_app_upd_fields x, mv_mcre0_app_istituti i
    WHERE     x.cod_macrostato = 'RIO'
          AND NVL (x.flg_outsourcing, 'N') = 'Y'
          AND x.cod_abi_cartolarizzato = i.cod_abi;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_RIO_POS_DA_LAV TO MCRE_USR;
