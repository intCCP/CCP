/* Formatted on 17/06/2014 18:16:27 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_RICERCA_ABI_NOME
(
   COD_COMPARTO,
   COD_RAMO_CALCOLATO,
   COD_ABI_ISTITUTO,
...
AS
   WITH v0
        ...
        AS (SELECT                                      -- 111111 v1 - solo IN
              ...
              FROM vtmcre0_app_upd_fields_pall x, t_mcre0_app_utenti u
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_RICERCA_ABI_NOME TO MCRE_USR;
