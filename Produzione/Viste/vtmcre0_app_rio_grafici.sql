/* Formatted on 17/06/2014 18:16:44 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_RIO_GRAFICI
(
   COD_SNDG,
   ...
   SELECT x.cod_sndg,
     ...
     FROM (SELECT 'A' val_label, ga.*
           ...
           SELECT cod_azione val_label, fase.*
             FROM vtmcre0_app_rio_grafico_fase fase) a,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_RIO_GRAFICI TO MCRE_USR;
