/* Formatted on 17/06/2014 18:09:03 (QP5 v5.227.12220.39754) */
   ...
   SELECT DISTINCT /*+ FIRST_ROWS(10) */
     ...
     FROM (SELECT                         --check sugli abi Cruscotto caricati
            ...
            WHERE                                         --a.flg_active = '1'
                      --AND
                      a.cod_abi_cartolarizzato = i.cod_abi
           ...
           SELECT cod_abi_cartolarizzato AS cod_abi,
            ...
            WHERE                                        -- a.flg_active = '1'
                      --AND
                      NVL (a.SCSB_UTI_TOT, 0) + NVL (SCSB_ACC_TOT, 0) > 0
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_POSIZIONI_LAVORABILI TO MCRE_USR;
