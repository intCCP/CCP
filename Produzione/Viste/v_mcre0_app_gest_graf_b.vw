/* Formatted on 17/06/2014 18:01:55 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_GEST_GRAF_B
(
...
AS
   SELECT X.COD_ABI_CARTOLARIZZATO,
    ...
    WHERE     X.COD_ABI_CARTOLARIZZATO = G.COD_ABI_CARTOLARIZZATO
          ...
          AND A.ID_AZIONE IN ('03', '04', '05')
          AND G.FLG_DELETE = 'N';


GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_GEST_GRAF_B TO MCRE_USR;
