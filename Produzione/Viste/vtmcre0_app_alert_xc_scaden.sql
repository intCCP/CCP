/* Formatted on 17/06/2014 18:15:26 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ALERT_XC_SCADEN
(
   ...
   SELECT                                   -- DECODE COLORE GIALLO AD arancio
         d.cod_abi_cartolarizzato,
          ...
          (SELECT flg_lavorabile
             FROM vtmcrei_posizioni_lavorabili pl
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ALERT_XC_SCADEN TO MCRE_USR;
