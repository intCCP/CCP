/* Formatted on 17/06/2014 18:04:41 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_P1_OLD
(
   TODAY_FLG,
...
AS
   SELECT -- 1.0 21/05/2012 Valeria Galli flg_blocco (Commenti con label: VG - CIB/BDT - INIZIO)
     ...
     FROM T_MCRE0_APP_ALL_DATA_OLD PARTITION (CCP_P1);


GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_P1_OLD TO MCRE_USR;
