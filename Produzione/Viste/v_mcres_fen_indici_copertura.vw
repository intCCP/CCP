/* Formatted on 17/06/2014 18:12:10 (QP5 v5.227.12220.39754) */
       ...
       FROM (  SELECT c.COD_ABI,
             ...
             GROUP BY c.COD_ABI,
                      ...
                      CASE
                         ...
                         ELSE 'A'
                      END) TMP
   GROUP BY COD_ABI, VAL_ANNOMESE, VAL_GESTIONE
   UNION ALL
     SELECT COD_ABI,
            VAL_ANNOMESE,
            VAL_GESTIONE,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_FEN_INDICI_COPERTURA TO MCRE_USR;
