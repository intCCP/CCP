/* Formatted on 17/06/2014 18:15:18 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ALERT_SAG_DA_ALL
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
...
AS
   SELECT /*+ordered no_parallel(a) no_parallel(t)*/
         ...
         DECODE (
            ...
            '0')
            FLG_ABI_LAVORATO
    FROM T_MCRE0_APP_ALERT_POS A, T_MCRE0_APP_SAG T, -- todo_verificare che sia sufficiente lavorare sulla partizione attiva
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ALERT_SAG_DA_ALL TO MCRE_USR;
