/* Formatted on 17/06/2014 18:17:22 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_UPD_FIELDS_PALL
(
   TODAY_FLG,
...
GRANT SELECT ON MCRE_OWN.VTMCRE0_APP_UPD_FIELDS_PALL TO MCRE_USR;
