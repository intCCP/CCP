/* Formatted on 17/06/2014 18:08:25 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_LISTA_RAP_PROPOSTE
(
...
AS
   SELECT rp.cod_abi AS cod_abi_cartolarizzato,
          rp.cod_ndg,
          rp.cod_rapporto,
          rp.cod_protocollo_delibera,                                 --27 nov
     ...
     FROM t_mcrei_app_rapporti_proposte rp, t_mcre0_app_natura_ftecnica nat
    WHERE rp.cod_forma_tecnica = nat.cod_ftecnica;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_APP_LISTA_RAP_PROPOSTE TO MCRE_USR;
