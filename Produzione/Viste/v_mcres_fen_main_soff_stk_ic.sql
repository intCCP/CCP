/* Formatted on 17/06/2014 18:12:17 (QP5 v5.227.12220.39754) */
   ...
   SELECT COD_ABI,
     ...
     FROM (SELECT A.*,
             ...
             FROM (  SELECT CP.COD_ABI,
                      ...
                      WHERE     UPPER (CP.VAL_FIRMA) != 'FIRMA'
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_FEN_MAIN_SOFF_STK_IC TO MCRE_USR;
