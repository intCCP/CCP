/* Formatted on 17/06/2014 18:04:35 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_DAY
(
   TODAY_FLG,
   FLG_ACTIVE,
...
AS
   SELECT                   /*---+INDEX_NOINDEX(P IX5_T_MCRE0_APP_ALL_DATA) */
     ...
     FROM V_MCRE0_APP_UPD_FIELDS_P1_DAY P,
...
GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_DAY TO MCRE_USR;
