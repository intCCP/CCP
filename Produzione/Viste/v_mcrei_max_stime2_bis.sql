/* Formatted on 17/06/2014 18:09:01 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_MAX_STIME2_BIS
(
   COD_ABI,
   COD_NDG,
   COD_RAPPORTO,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON MCRE_OWN.V_MCREI_MAX_STIME2_BIS TO MCRE_USR;
