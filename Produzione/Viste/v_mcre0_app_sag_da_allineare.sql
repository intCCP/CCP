/* Formatted on 17/06/2014 18:04:07 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_SAG_DA_ALLINEARE
(
   VAL_ALERT,
   DTA_INS_ALERT,
   COD_SNDG,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_SAG_DA_ALLINEARE TO MCRE_USR;
