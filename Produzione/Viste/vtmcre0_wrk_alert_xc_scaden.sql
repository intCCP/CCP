/* Formatted on 17/06/2014 18:17:43 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_WRK_ALERT_XC_SCADEN
(
   COD_ABI,
   COD_ABI_ISTITUTO,
   COD_NDG,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_WRK_ALERT_XC_SCADEN TO MCRE_USR;
