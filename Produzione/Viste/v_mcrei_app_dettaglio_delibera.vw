/* Formatted on 17/06/2014 18:08:10 (QP5 v5.227.12220.39754) */
   ...
   SELECT /******************************************************************************
    ...
    FROM t_mcrei_app_delibere d,
         ...
         (SELECT DISTINCT cod_abi,
           ...
           WHERE     flg_attiva = '1'
                 AND desc_parere = 'INCAGLIO AUTOMATICO DA SAG' /* unico modo per identificare univocamente è la descrizione */
                                                               ) par
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_APP_DETTAGLIO_DELIBERA TO MCRE_USR;
