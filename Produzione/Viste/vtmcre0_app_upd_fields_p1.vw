/* Formatted on 17/06/2014 18:17:21 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_UPD_FIELDS_P1
(
   TODAY_FLG,
...
AS
   SELECT -- 1.0 21/05/2012 Valeria Galli flg_blocco (Commenti con label: VG - CIB/BDT - INIZIO)
     ...
     FROM T_MCRE0_ALL_DATA PARTITION (CCP_P1);


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_UPD_FIELDS_P1 TO MCRE_USR;
