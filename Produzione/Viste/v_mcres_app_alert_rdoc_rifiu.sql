/* Formatted on 17/06/2014 18:09:35 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_ALERT_RDOC_RIFIU
(
   ID_ALERT,
   COD_ABI,
   COD_NDG,
...
AS
   SELECT                -- AP 13/05/2014 alert Raccolta documentale rifiutata
         ga.id_alert,
          p.cod_abi,
          p.cod_ndg,
          p.cod_sndg,
            ...
            WHERE     0 = 0
                  ...
                  AND EXISTS
                         (SELECT DISTINCT 1
                           ...
                           WHERE     cod_stato_raccolta_doc = 3
    ...
    WHERE     1 = 1
          ...
          AND uo.cod_Stato_Raccolta_doc = 3;


GRANT SELECT ON MCRE_OWN.V_MCRES_APP_ALERT_RDOC_RIFIU TO MCRE_USR;
