/* Formatted on 17/06/2014 18:08:58 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_MAX_STIME
(
   COD_ABI,
   COD_NDG,
   COD_RAPPORTO,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_MAX_STIME TO MCRE_USR;
