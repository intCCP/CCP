/* Formatted on 17/06/2014 18:10:52 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_APP_PIANI_RIENTRO
(
   COD_ABI,
   COD_NDG,
   COD_RAPPORTO,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRES_APP_PIANI_RIENTRO TO MCRE_USR;
