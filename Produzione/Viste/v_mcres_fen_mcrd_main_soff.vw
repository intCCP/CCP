/* Formatted on 17/06/2014 18:12:19 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_FEN_MCRD_MAIN_SOFF
(
   COD_ABI,
   ID_DPER,
   COD_NDG,
   ...
   SELECT "COD_ABI",
     ...
     FROM (SELECT cod_abi,
           ...
           SELECT cod_abi,
                  ...
                  cod_sndg,
                  SYSDATE
             FROM v_mcres_fen_mcrd_mainsofidc
           UNION ALL
           SELECT cod_abi,
                  id_dper,
                  cod_ndg,
                  ...
                  cod_sndg,
                  SYSDATE
             FROM V_MCRES_FEN_mcrd_MAINSOFCHIUSE);


GRANT SELECT ON MCRE_OWN.V_MCRES_FEN_MCRD_MAIN_SOFF TO MCRE_USR;
