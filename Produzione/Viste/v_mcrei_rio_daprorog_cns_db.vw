/* Formatted on 17/06/2014 18:09:04 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_RIO_DAPROROG_CNS_DB
(
   REC
)
AS
...
GRANT SELECT ON MCRE_OWN.V_MCREI_RIO_DAPROROG_CNS_DB TO MCRE_USR;
