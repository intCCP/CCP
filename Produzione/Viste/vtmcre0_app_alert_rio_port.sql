/* Formatted on 17/06/2014 18:15:14 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ALERT_RIO_PORT
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
...
AS
   SELECT /*+ordered no_parallel(a) */
         ALERT_12 VAL_ALERT,
          ...
          X.ID_REFERENTE
     FROM VTMCRE0_APP_ALERT_POS A, -- todo_verificare che sia sufficiente lavorare sulla partizione attiva
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ALERT_RIO_PORT TO MCRE_USR;
