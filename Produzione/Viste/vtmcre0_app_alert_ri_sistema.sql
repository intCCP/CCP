/* Formatted on 17/06/2014 18:15:08 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_ALERT_RI_SISTEMA
(
   VAL_ALERT,
   VAL_ORDINE_COLORE,
   DTA_INS_ALERT,
...
AS
   SELECT /*+ordered no_parallel(a) no_parallel(cr)*/
    ...
    FROM T_MCRE0_APP_ALERT_POS A, VTMCRE0_APP_UPD_FIELDS X, T_MCRE0_APP_CR CR
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_ALERT_RI_SISTEMA TO MCRE_USR;
