/* Formatted on 17/06/2014 18:12:18 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_FEN_MCRD_INDICI_COP
(
   COD_ABI,
   ID_DPER,
   VAL_ANNOMESE,
...
GRANT SELECT ON MCRE_OWN.V_MCRES_FEN_MCRD_INDICI_COP TO MCRE_USR;
