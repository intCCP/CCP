/* Formatted on 17/06/2014 18:04:53 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_CHECK_POS_MACROSTATO
(
   MACROSTATO,
   POS_DIR,
   POS
...
GRANT SELECT ON MCRE_OWN.V_MCRE0_CHECK_POS_MACROSTATO TO MCRE_USR;
