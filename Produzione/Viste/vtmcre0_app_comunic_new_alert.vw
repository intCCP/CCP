/* Formatted on 17/06/2014 18:15:37 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_COMUNIC_NEW_ALERT
(
...
AS
   SELECT                                           /*ordered noparallel(a) */
     ...
     FROM (SELECT /*+ ORDERED */
          ...
          vtmcre0_app_upd_fields f
    WHERE     f.cod_abi_cartolarizzato = s.cod_abi_cartolarizzato
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_COMUNIC_NEW_ALERT TO MCRE_USR;
