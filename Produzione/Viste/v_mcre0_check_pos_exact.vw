/* Formatted on 17/06/2014 18:04:51 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_CHECK_POS_EXACT
(
   CONTROLLO,
   POS
)
AS
   ...
   SELECT 'Posizioni con comparto diverso da quello del gestore' AS controllo,
          COUNT (*) quanti
     FROM t_mcre0_app_all_data a, t_mcre0_app_utenti b
    WHERE     1 = 1
...
GRANT SELECT ON MCRE_OWN.V_MCRE0_CHECK_POS_EXACT TO MCRE_USR;
