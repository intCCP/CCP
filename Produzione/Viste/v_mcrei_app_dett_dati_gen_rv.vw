/* Formatted on 17/06/2014 18:07:52 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCREI_APP_DETT_DATI_GEN_RV
(
   COD_ABI,
   COD_NDG,
   COD_PROT_DELIBERA,
...
AS
   SELECT -- 23/10/2012 I.Gueorguieva Aggiunte distinct nelle sottoselect sulle stime, che moltiplicavano i record per rapporto
     ...
     FROM ( (SELECT DISTINCT
               ...
               FROM v_mcrei_app_dett_rapporti_rv r,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCREI_APP_DETT_DATI_GEN_RV TO MCRE_USR;
