/* Formatted on 17/06/2014 18:15:29 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_API
(
   COD_ABI_ISTITUTO,
...
AS
   SELECT fg.COD_ABI_ISTITUTO,
          ...
          '                   ' AS record_char
     FROM MVTMCRE0_APP_UPD_FIELD fg
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_API TO MCRE_USR;
