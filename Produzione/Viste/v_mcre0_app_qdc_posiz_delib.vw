/* Formatted on 17/06/2014 18:03:01 (QP5 v5.227.12220.39754) */
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON MCRE_OWN.V_MCRE0_APP_QDC_POSIZ_DELIB TO MCRE_USR;
