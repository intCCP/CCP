/* Formatted on 17/06/2014 18:04:36 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_OLD
(
   TODAY_FLG,
   FLG_ACTIVE,
...
AS
   SELECT                   /*---+INDEX_NOINDEX(P IX5_T_MCRE0_APP_ALL_DATA) */
     ...
     FROM V_MCRE0_APP_UPD_FIELDS_P1_OLD P,
...
GRANT SELECT ON MCRE_OWN.V_MCRE0_APP_UPD_FIELDS_OLD TO MCRE_USR;
