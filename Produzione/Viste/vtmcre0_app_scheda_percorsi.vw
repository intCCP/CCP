/* Formatted on 17/06/2014 18:17:13 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.VTMCRE0_APP_SCHEDA_PERCORSI
(
   ...
   SELECT   --110926: corretto nullif cod_stato, condizione su stati non nulli
     ...
     FROM (SELECT DISTINCT
            ...
            WHERE     tfin.cod_abi_cartolarizzato =
                  ...
                  AND SUBSTR (TFIN.TMS, 0, 13) BETWEEN SUBSTR (rs.TMS_INI(+),
                                                               0,
                                                               13)
                                                   AND NVL (
                                                          SUBSTR (
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON MCRE_OWN.VTMCRE0_APP_SCHEDA_PERCORSI TO MCRE_USR;
