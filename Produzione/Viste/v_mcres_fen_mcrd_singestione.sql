/* Formatted on 17/06/2014 18:12:30 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW MCRE_OWN.V_MCRES_FEN_MCRD_SINGESTIONE
(
   ID_DPER,
   COD_ABI,
   VAL_ANNOMESE,
...
GRANT SELECT ON MCRE_OWN.V_MCRES_FEN_MCRD_SINGESTIONE TO MCRE_USR;
